...
<section class="headerWrapper" >
   ...
   <a href="#services" class="mouse smoothscroll">
		   <img src="http://legalcenter.pro/wp-content/themes/lawyer/img/mouse.png" alt="">
   </a>
</section>
	...
	<div class="aboutWrap">
		...
		<div class="aboutContent">
			...
			<?php if (ot_get_option( 'quote__descr' )) {?>
			   <?php echo ot_get_option( 'quote__descr' ); ?>		    
			<?php } ?>	
			<!-- </div> -->
	...
	<div class="profitWrapp">
		...
		<div class="profitWrapp__firstLine">
			<div class="profitItem profitItem__bg_1">
				...
				<div class="profitItem__title">
					<h5>Провели <span>1600</span><br> судебных заседаний</h5>
				</div>
			</div>
			...
			<div class="profitItem profitItem__bg_2">
				...
				<div class="profitItem__title">
					<h5>Побеждаем с <span>95%</span> <br>вероятностью</h5>
				</div>
			</div>
			...
			<div class="profitItem profitItem__bg_3">
				...
				<div class="profitItem__title">
					<h5><span>500</span><br> млн рублей – общая сумма проведенных нами дел</h5>
				</div>
			</div>
		</div>
		...
		<div class="profitWrapp__secdLine">
			<div class="profitItem profitItem__bg_4">
				...
				<div class="profitItem__title">
					<h5>Имеем опыт защиты клиента без его присутствия в суде</h5>
				</div>
			</div>
...
<section class="cases" id="cases"  style="display: none;">
	...
	<div class="frame" id="basic">
		<ul class="clearfix">
			   ...
			   <?php 
			    ...
			    <!-- <li class="clearfix_li"> --> <!-- 1 карточка  -->
			    <li class="casesItem"> <!-- 1 карточка  -->
			    	<!-- <div class="casesItem"> -->
